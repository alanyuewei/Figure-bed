...
<html lang="zh-CN"><head>
    ...
    <meta name="description" content="皮皮赖图床（https://www.52bz.la/tu）,一个为站长提供高速，有限的外链图床站点！">
    <meta name="keywords" content="皮皮赖,皮皮赖图床,新浪图床,百度图床,搜狗图床,SMMS图床,链图云图床">
    ...
    <link rel="stylesheet" href="https://cdn.bootcss.com/layer/2.3/skin/layer.css" id="layui_layer_skinlayercss"></head>
...
<div class="container" style="padding-top:55px;">
    <div class="col-xs-12 col-sm-10 col-md-8 col-lg-6 center-block text-center" style="float: none;">
        <div class="panel panel-primary">
            <div class="panel-heading" style="background: linear-gradient(to right,#8ae68a,#5ccdde,#b221ff);"><font color="#000000">选择或拖拽一张图片开始上传...</font></div>
            <div class="panel-body text-center">
                <form action="./" method="post" enctype="multipart/form-data">
                    <center>
                        <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=369994633&amp;site=qq&amp;menu=yes"><img class="img-circle m-b-xs" style="border: 2px solid #1281FF; margin-left:3px; margin-right:3px;" src="https://q4.qlogo.cn/headimg_dl?dst_uin=369994633&amp;spec=100" ;="" width="60px" height="60px" alt="皮皮赖-极简高速外链图床"></a>
                        <p>
                            <font color="success">皮皮赖-极简高速外链图床</font>
                        </p><p>
                            <input type="file" name="pic" class="btn btn-default">
                            <?php if (!empty($imgarrapi)) {
